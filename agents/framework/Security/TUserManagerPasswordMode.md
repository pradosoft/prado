...
|----------|-------|-------------|
| `Clear` | `'Clear'` | Plain text password |
| `MD5` | `'MD5'` | MD5 hash of password |
| `SHA1` | `'SHA1'` | SHA1 hash of password |

## See Also

- [TUserManager](./TUserManager.md) - Uses this enum for password mode
