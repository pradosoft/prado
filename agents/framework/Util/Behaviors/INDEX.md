...
### Directories
[framework](../../INDEX.md) / [Util](../INDEX.md) / **`Behaviors`**
...
- Behaviors in this directory are designed to be attached via `application.xml` using [`TBehaviorsModule`](../TBehaviorsModule.md) or attached programmatically with `attachBehavior()`.
