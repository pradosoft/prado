# Util/Log/TStdOutLogRoute

### Directories
[framework](../../INDEX.md) / [Util](../INDEX.md) / [Log](./INDEX.md) / **`TStdOutLogRoute`**

## Class Info
**Location:** `framework/Util/Log/TStdOutLogRoute.php`
...
<modules>
  <module id="log" class="Prado\Util\Log\TLogRouter">
    <route class="Prado\Util\Log\TStdOutLogRoute" Levels="Debug|Info|Warning|Error" />
  </module>
</modules>
```
...
return [
    'modules' => [
        'log' => [
            ...
            'routes' => [
                ['class' => 'Prado\Util\Log\TStdOutLogRoute', 'properties' => ['Levels' => 'Debug|Info|Warning|Error']],
            ],
        ],
    ],
];
