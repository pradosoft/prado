# Util/Log/TEmailLogRoute

### Directories
[framework](../../INDEX.md) / [Util](../INDEX.md) / [Log](./INDEX.md) / **`TEmailLogRoute`**

## Class Info
**Location:** `framework/Util/Log/TEmailLogRoute.php`
...
<modules>
  <module id="log" class="Prado\Util\Log\TLogRouter">
    <route class="Prado\Util\Log\TEmailLogRoute" Emails="admin@example.com" Subject="Application Error" SentFrom="app@example.com" Levels="Error|Fatal" />
  </module>
</modules>
```
...
return [
    'modules' => [
        'log' => [
            ...
            'routes' => [
                ['class' => 'Prado\Util\Log\TEmailLogRoute', 'properties' => ['Emails' => 'admin@example.com', 'Subject' => 'Application Error', 'SentFrom' => 'app@example.com']],
            ],
        ],
    ],
];
