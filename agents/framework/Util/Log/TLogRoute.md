...
### Directories
[framework](../../INDEX.md) / [Util](../INDEX.md) / [Log](./INDEX.md) / **`TLogRoute`**

## Class Info
**Location:** `framework/Util/Log/TLogRoute.php`
...
```xml
<route class="Prado\Util\Log\TFileLogRoute"
...
```xml
<route class="Prado\Util\Log\TDbLogRoute"
       ConnectionID="db"
...
```xml
<route class="Prado\Util\Log\TEmailLogRoute"
...
```xml
<route class="Prado\Util\Log\TBrowserLogRoute" Levels="Debug|Info|Warning|Error" />
```
...
```xml
<route class="Prado\Util\Log\TStdOutLogRoute" />
```
...
```xml
<route class="Prado\Util\Log\TSysLogRoute" Levels="Error|Fatal" />
```
