# Util/Log/TSysLogRoute

### Directories
[framework](../../INDEX.md) / [Util](../INDEX.md) / [Log](./INDEX.md) / **`TSysLogRoute`**

## Class Info
**Location:** `framework/Util/Log/TSysLogRoute.php`
...
<modules>
  <module id="log" class="Prado\Util\Log\TLogRouter">
    <route class="Prado\Util\Log\TSysLogRoute" SysLogPrefix="myapp" Levels="Error|Fatal" />
  </module>
</modules>
```
...
return [
    'modules' => [
        'log' => [
            ...
            'routes' => [
                ['class' => 'Prado\Util\Log\TSysLogRoute', 'properties' => ['SysLogPrefix' => 'myapp', 'Levels' => 'Error|Fatal']],
            ],
        ],
    ],
];
