# Util/Log/TBrowserLogRoute

### Directories
[framework](../../INDEX.md) / [Util](../INDEX.md) / [Log](./INDEX.md) / **`TBrowserLogRoute`**

## Class Info
**Location:** `framework/Util/Log/TBrowserLogRoute.php`
...
return [
    'modules' => [
        'log' => [
            ...
            'routes' => [
                ['class' => 'Prado\Util\Log\TBrowserLogRoute', 'properties' => ['Levels' => 'Debug|Info|Warning|Error']],
            ],
        ],
    ],
];
