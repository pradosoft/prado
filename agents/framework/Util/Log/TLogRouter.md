...
### Directories
[framework](../../INDEX.md) / [Util](../INDEX.md) / [Log](./INDEX.md) / **`TLogRouter`**

## Class Info
**Location:** `framework/Util/Log/TLogRouter.php`
...
<modules>
    <module id="log" class="Prado\Util\Log\TLogRouter">
        ...
        <route class="Prado\Util\Log\TBrowserLogRoute"
...
return [
    'modules' => [
        'log' => [
            ...
            'routes' => [
                ['class' => 'Prado\Util\Log\TFileLogRoute', 'properties' => ['Levels' => 'error,warning']],
            ],
        ],
    ],
];
