...
| Directory | Purpose |
|---|---|
| [`Behaviors/`](UTIL_BEHAVIORS_INDEX.md) | Pre-built installable behaviors (lazy loading, page behaviors, signals, etc.) |
| [`Cron/`](UTIL_CRON_INDEX.md) | Scheduled task engine: `TCronModule`, `TDbCronModule`, `TTimeScheduler` |
| [`Helpers/`](UTIL_HELPERS_INDEX.md) | Static utility classes: `TArrayHelper`, `TBitHelper`, `TProcessHelper` |
| [`Math/`](UTIL_MATH_INDEX.md) | `TRational`, `TURational` — rational number arithmetic |
