...
[framework](../../INDEX.md) / [Data](../INDEX.md) / **`ActiveRecord`**
...
| [`Scaffold/`](INDEX.md) | Auto-generated CRUD UI controls (`TScaffoldListView`, `TScaffoldEditView`, etc.) |
| [`Scaffold/InputBuilder/`](INDEX.md) | Driver-specific column-to-control mapping for scaffold edit forms |
