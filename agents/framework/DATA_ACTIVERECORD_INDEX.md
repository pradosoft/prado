# Data/ActiveRecord/INDEX.md - DATA_ACTIVERECORD_INDEX.md
...
| Directory | Purpose |
|---|---|
| [`Exceptions/`](DATA_ACTIVERECORD_EXCEPTIONS_INDEX.md)] | `TActiveRecordException`, `TActiveRecordConfigurationException` |
| [`Relations/`](DATA_ACTIVERECORD_RELATIONS_INDEX.md) | `TActiveRecordHasOne`, `HasMany`, `BelongsTo`, `HasManyAssociation` + context class |
| [`Scaffold/`](DATA_ACTIVERECORD_SCAFFOLD_INDEX.md) | Auto-generated CRUD UI controls (`TScaffoldListView`, `TScaffoldEditView`, etc.) |
| [`Scaffold/InputBuilder/`](DATA_ACTIVERECORD_SCAFFOLD_INPUTBUILDER_INDEX.md) | Driver-specific column-to-control mapping for scaffold edit forms |
