# Data/Common/INDEX.md - DATA_COMMON_INDEX.md
...
|---|---|---|
| [`Mssql/`](DATA_COMMON_MSSQL_INDEX.md) | SQL Server | `mssql`, `sqlsrv`, `dblib` |
| [`Mysql/`](DATA_COMMON_MYSQL_INDEX.md) | MySQL / MariaDB | `mysql`, `mysqli` |
| [`Oracle/`](DATA_COMMON_ORACLE_INDEX.md) | Oracle | `oci` |
| [`Pgsql/`](DATA_COMMON_PGSQL_INDEX.md) | PostgreSQL | `pgsql` |
| [`Sqlite/`](DATA_COMMON_SQLITE_INDEX.md) | SQLite | `sqlite`, `sqlite2` |
