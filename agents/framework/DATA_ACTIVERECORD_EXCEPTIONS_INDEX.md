# Data/ActiveRecord/Exceptions/INDEX.md - DATA_ACTIVERECORD_EXCEPTIONS_INDEX.md
...
- Exception message keys are defined in `framework/Exceptions/messages/messages.txt` and must be added there for new error codes.
