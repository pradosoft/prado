# Web/UI/WebControls/INDEX.md - WEB_UI_WEBCONTROLS_INDEX.md
...
| Directory | Purpose |
|---|---|
| [`assets/`](WEB_UI_WEBCONTROLS_ASSETS_INDEX.md) | Static assets published to the web by `TAssetManager` |
...
- **`TWebControl`** — Base for all WebControls. Adds HTML attribute management (style, CSS class, AccessKey, TabIndex, ToolTip, etc.) and standard HTML rendering helpers. Extends `TControl`.
