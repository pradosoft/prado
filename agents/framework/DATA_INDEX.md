...
| Directory | Purpose |
|---|---|
| [`ActiveRecord/`](DATA_ACTIVERECORD_INDEX.md)] | Stateful ORM |
| [`Common/`](DATA_COMMON_INDEX.md) | Driver-Specific Implementations |
| [`DataGateway/`](DATA_DATAGATEWAY_INDEX.md) | Stateless Table Gateway |
| [`SqlMap/`](DATA_SQLMAP_INDEX.md) | XML-based SQL Mapping (iBATIS-style) |
