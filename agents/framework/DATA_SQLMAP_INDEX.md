# Data/SqlMap/INDEX.md - DATA_SQLMAP_INDEX.md
...
| Directory | Purpose |
|---|---|
| [`Configuration/`](DATA_SQLMAP_CONFIGURATION_INDEX.md) | XML parsing: statements, parameter maps, result maps, cache models |
| [`DataMapper/`](DATA_SQLMAP_DATAMAPPER_INDEX.md) | Runtime: type handlers, caches, lazy loading, exceptions |
| [`Statements/`](DATA_SQLMAP_STATEMENTS_INDEX.md) | Statement execution: SQL preparation, binding, result mapping |
