...
- `Table` - Items organized in an HTML table
- `Flow` - Items organized using spans and breaks
- `Raw` - Items stacked without decorations

## See Also

- [TRepeatDirection](./TRepeatDirection.md)
