...
- `CheckMXRecord` - Whether to check DNS MX records (default false)
- `EMAIL_REGEXP` - Regular expression for email validation

## See Also

- [TRegularExpressionValidator](./TRegularExpressionValidator.md)
