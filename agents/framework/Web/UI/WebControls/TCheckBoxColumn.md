...
- `DataField` - Field name from data source for checkbox state
- `ReadOnly` - Whether checkbox can be edited (default false)
- `initializeCell()` - Creates checkbox in cell
- `dataBindColumn()` - Binds data to checkbox checked state
