...
- `setOnDateChanged(string $javascript)` - Sets JavaScript code to execute when the date changes
- `getOnDateChanged()` - Returns the JavaScript code for the OnDateChanged event
