...
- `StartRowIndex` - Zero-based starting row index
- `MaximumRows` - Maximum rows to return
- `RetrieveTotalRowCount` - Whether to retrieve total count
- `TotalRowCount` - Total number of rows available
