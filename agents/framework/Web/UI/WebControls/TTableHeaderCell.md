...
- `getScope()` / `setScope($value)` - Scope of header cell (Row, Col)
- `getAbbreviatedText()` / `setAbbreviatedText($value)` - Abbreviation for the header
- `getCategoryText()` / `setCategoryText($value)` - Axis attribute (deprecated)
