...
- `ClientValidationFunction` - Name of client-side JS validation function
- `onServerValidate()` - Server-side validation handler event
- `evaluateIsValid()` - Invokes OnServerValidate event
