...
- `__construct($dataSource, $dataMember)` - Constructor accepting data source and member
- `getView($viewName)` - Returns a TReadOnlyDataSourceView

## See Also

- [IDataSource](./IDataSource.md)
- [TReadOnlyDataSourceView](./TReadOnlyDataSourceView.md)
