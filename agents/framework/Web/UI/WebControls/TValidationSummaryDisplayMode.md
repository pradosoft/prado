...
- `SimpleList` - Error messages as plain list
- `SingleParagraph` - Messages concatenated into a paragraph
- `BulletList` - Messages as bulleted list
- `HeaderOnly` - Only header text displayed
