...
- `None` - Error messages not displayed
- `Dynamic` - Messages dynamically shown/hidden as validators fail
- `Fixed` - Messages physically occupy page layout (may be hidden via CSS)
