...
- `createStyle()` - Creates TTableItemStyle
- `getStyle()` / `clearStyle()` - Style management
- `bubbleEvent()` - Bubbles OnCommand events
- `render()` / `renderBeginTag()` / `renderContents()` / `renderEndTag()` - Rendering
