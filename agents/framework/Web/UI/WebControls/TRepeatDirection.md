...
- `Vertical` - Items flow vertically (top to bottom, then left to right)
- `Horizontal` - Items flow horizontally (left to right, then top to bottom)

## See Also

- [TRepeatLayout](./TRepeatLayout.md)
