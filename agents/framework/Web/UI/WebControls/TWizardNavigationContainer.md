...
- `getPreviousButton()` / `setPreviousButton($value)` - Previous button control
- `getNextButton()` / `setNextButton($value)` - Next button control
- `getCancelButton()` / `setCancelButton($value)` - Cancel button control
- `getCompleteButton()` / `setCompleteButton($value)` - Complete button control
