...
- `MinSelection` - Minimum required selections
- `MaxSelection` - Maximum allowed selections
- `RequiredSelections` - Comma-separated list of required values
- `evaluateIsValid()` - Validates selection count and required values
