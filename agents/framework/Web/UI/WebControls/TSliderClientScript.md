...
- `getOnChange()` / `setOnChange($javascript)` - JavaScript executed when slider value changes
- `getOnSlide()` / `setOnSlide($javascript)` - JavaScript executed when slider moves
