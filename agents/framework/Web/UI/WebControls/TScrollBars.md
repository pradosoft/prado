...
- `None` - No scroll bars
- `Auto` - Scroll bars automatically appear when needed
- `Both` - Always show both horizontal and vertical scroll bars
- `Horizontal` - Show horizontal scroll bar only
- `Vertical` - Show vertical scroll bar only
