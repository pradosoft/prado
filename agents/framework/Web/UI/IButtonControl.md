...
### Directories
[framework](../../INDEX.md) / [Web](../INDEX.md) / [UI](INDEX.md) / **`IButtonControl`**
...
- [TButton](WebControls/TButton.md) - Button implementation
- [TLinkButton](WebControls/TLinkButton.md) - Link button implementation
