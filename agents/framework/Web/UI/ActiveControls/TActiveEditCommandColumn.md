...
- `createButton(...)` - Creates [TActiveLinkButton](./TActiveLinkButton.md), [TActiveButton](./TActiveButton.md), or [TActiveImageButton](./TActiveImageButton.md) based on button type

## See Also

- `TEditCommandColumn`, [TActiveDataGrid](./TActiveDataGrid.md)
