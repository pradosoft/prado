...
- `initializeCell($cell, $columnIndex, $itemType)` - Creates TActiveCheckbox for item cells
- `initializeHeaderCell($cell, $columnIndex)` - Creates active controls for sortable headers

## See Also

- `TCheckBoxColumn`, [TActiveDataGrid](./TActiveDataGrid.md), [TActiveCheckBox](./TActiveCheckBox.md)
