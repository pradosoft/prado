...
/**
 * UpsertTestRecord — ActiveRecord fixture for insertOrIgnore and upsert integration tests (Firebird).
 *
 * Maps to the `upsert_test` table:
 *   username VARCHAR(100) PK
 *   score    INTEGER DEFAULT 0
 *
 * Firebird's upsert_test uses username as the primary key (no auto-increment id).
 */
class FirebirdUpsertTestRecord extends TActiveRecord
{
	public $username;
	public $score = 0;
