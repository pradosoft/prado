...
/**
 * ActiveRecordSqlSrvInsertOrIgnoreTest — integration tests for {@see TActiveRecord::insertOrIgnore()} on SQL Server.
 *
 ...
 */
class ActiveRecordSqlSrvInsertOrIgnoreTest extends PHPUnit\Framework\TestCase
{
