...
/**
 * ActiveRecordOracleUpsertTest — integration tests for {@see TActiveRecord::upsert()} on Oracle.
 *
 ...
 */
class ActiveRecordOracleUpsertTest extends PHPUnit\Framework\TestCase
{
	...
	{
		$original = new OracleUpsertTestRecord();
		$original->username = 'alice';
		$original->score = 10;
		$original->upsert();

		$update = new OracleUpsertTestRecord();
	...
	public function test_upsert_does_not_affect_other_rows(): void
	{
		...
		$bob = OracleUpsertTestRecord::finder()->findByPk('bob');
