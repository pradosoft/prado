...
class CommandBuilderMysqlTest extends PHPUnit\Framework\TestCase
{
	...
	public function test_mysql_no_limit_or_offset()
	{
	...
	public function test_mysql_limit_only()
	{
		$builder = new TMysqlCommandBuilder();
	...
	public function test_mysql_limit_with_negative_offset()
	{
		$builder = new TMysqlCommandBuilder();
	...
	public function test_mysql_limit_and_offset()
	{
		$builder = new TMysqlCommandBuilder();
	...
	public function test_mysql_zero_limit()
	{
		$builder = new TMysqlCommandBuilder();
	...
	public function test_mysql_zero_limit_zero_offset()
	{
		$builder = new TMysqlCommandBuilder();
	...
	public function test_mysql_zero_offset_only()
	{
		$builder = new TMysqlCommandBuilder();
	...
	public function test_mysql_limit_with_zero_offset()
	{
		$builder = new TMysqlCommandBuilder();
