...
/**
 * ActiveRecordSqliteInsertOrIgnoreTest — integration tests for {@see TActiveRecord::insertOrIgnore()} on SQLite.
 *
 ...
 */
class ActiveRecordSqliteInsertOrIgnoreTest extends PHPUnit\Framework\TestCase
{
	...
	public function test_insertOrIgnore_duplicate_returns_false(): void
	{
		...
		$duplicate = new SqliteUpsertTestRecord();
