-- IBM DB2 SqlMap test database.
-- Run via: db2 -td@ -f database.sql after connecting to pradount.
-- Statements terminated with @ as DB2 uses ; inside compound blocks.
...
CREATE TABLE Users (
    LogonId VARCHAR(20) NOT NULL PRIMARY KEY,
    Name VARCHAR(40),
    Password VARCHAR(20),
