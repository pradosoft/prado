/* SQL Server SqlMap test database schema.
   Connected to the prado_unitest database.
   Statements separated by semicolons for DefaultScriptRunner compatibility.
   Requires SQL Server 2016+ for DROP TABLE IF EXISTS. */
...
CREATE TABLE Categories (
    Category_Id INTEGER NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE LineItems (
    ...
    LineItem_Picture VARBINARY(MAX)
);
