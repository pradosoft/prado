-- Pgsql SqlMap test database schema.
-- Run as prado_unitest against prado_unitest database.
...
DROP TABLE IF EXISTS Enumerations CASCADE;
...
DROP SEQUENCE IF EXISTS lineitem_seq;
...
CREATE TABLE Categories (
    Category_Id INTEGER NOT NULL DEFAULT nextval('categories_seq') PRIMARY KEY,
...
CREATE SEQUENCE lineitem_seq START 1;
...
CREATE TABLE Others (
    Other_Int INTEGER,
    Other_Long BIGINT,
    Other_Bit SMALLINT NOT NULL DEFAULT 0,
...
CREATE TABLE Users (
    LogonId VARCHAR(20) NOT NULL DEFAULT '0' PRIMARY KEY,
    Name VARCHAR(40),
    Password VARCHAR(20),
