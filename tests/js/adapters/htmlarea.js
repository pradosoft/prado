 ...
 * Adapter: htmlarea
 *
 * Exposes Prado.WebUI.THtmlArea as a named export so that test files can
 * import specific symbols by name.
 *
 * tinyMCE must be set up on global BEFORE this adapter is imported (or at
 * least before a THtmlArea instance is constructed).  The test files that
...
// inside htmlarea.js can reference it safely.  Individual tests override this
...
loadScript('framework/Web/Javascripts/source/prado/controls/htmlarea.js');

export const THtmlArea = global.Prado.WebUI.THtmlArea;
