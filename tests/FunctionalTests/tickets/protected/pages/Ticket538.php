...
class Ticket538 extends TPage
{
	...
	{
		$data = [
		['id' => '001', 'name' => 'John', 'age' => 31],
		['id' => '002', 'name' => 'Mary', 'age' => 30],
		['id' => '003', 'name' => 'Cary', 'age' => 20],
		['id' => '004', 'name' => 'Kevin', 'age' => 65],
		['id' => '005', 'name' => 'Steven', 'age' => 10],
		['id' => '006', 'name' => 'Josh', 'age' => 23],
		['id' => '007', 'name' => 'Lary', 'age' => 54]];
		return $data;
	}
