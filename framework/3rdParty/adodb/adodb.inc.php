...
*/
   ...
   */
	...
	*/
	...
	function &GetActiveRecords($class,$where=false,$bindarr=false,$primkeyArr=false)
	{
		$table = ADODB_Active_Record::_pluralize($class);
		$arr =& $this->GetActiveRecordsClass($class, $table, $where, $bindarr, $primkeyArr);
		return $arr;
	}
