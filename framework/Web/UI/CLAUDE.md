...
| Directory | Purpose |
|---|---|
| `ActiveControls/` | AJAX-enabled controls with callback mechanism |
| `JuiControls/` | jQuery UI widget wrappers |
| `WebControls/` | Standard HTML input, layout, data display, and validation controls. Contains `assets/` subdirectory with published CSS, images, and the `captcha.php` server-side CAPTCHA generator |
