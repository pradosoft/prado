...
class TButton extends \Prado\Web\UI\WebControls\TWebControl implements \Prado\Web\UI\IPostBackEventHandler, \Prado\Web\UI\IButtonControl, \Prado\IDataRenderer
{
	...
	/**
	 * @return \Prado\Web\UI\WebControls\TButtonTag the tag name of the button. Defaults to TButtonType::Input.
	 */
	...
	/**
	 * @param \Prado\Web\UI\WebControls\TButtonTag $value the tag name of the button.
	 */
	...
	/**
	 * @return \Prado\Web\UI\WebControls\TButtonType the type of the button. Defaults to TButtonType::Submit.
	 */
	...
	/**
	 * @param \Prado\Web\UI\WebControls\TButtonType $value the type of the button.
	 */
