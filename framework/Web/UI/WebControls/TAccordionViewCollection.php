 ...
 *
 * TAccordionViewCollection is a collection of {@see TAccordionView} to be used inside a {@see TAccordion}.
 *
 * @author Gabor Berczi, DevWorx Hungary <gabor.berczi@devworx.hu>
 * @since 3.2
 */
class TAccordionViewCollection extends \Prado\Web\UI\TControlCollection
{
	 ...
	 * @throws TInvalidDataTypeException if the item to be inserted is not a {@see TAccordionView} object.
	 */
