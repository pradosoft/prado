...
class TDataGridPagerStyle extends TPanelStyle
{
	...
	{
		$this->_mode = TPropertyValue::ensureEnum($value, TDataGridPagerMode::class);
	}
	...
	{
		$this->_buttonType = TPropertyValue::ensureEnum($value, TDataGridPagerButtonType::class);
	}
	...
	{
		$this->_position = TPropertyValue::ensureEnum($value, TDataGridPagerPosition::class);
	}
