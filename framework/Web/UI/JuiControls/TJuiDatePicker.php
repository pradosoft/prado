 ...
 * entered into the text box. TJuiDatePicker is an extension to {@see \Prado\Web\UI\ActiveControls\TActivePanel} based on
...
class TJuiDatePicker extends TActiveTextBox implements INamingContainer, IJuiOptions
{
	...
	/**
	 * @return string|TTextBoxMode the behavior mode of the underlying {@see \Prado\Web\UI\WebControls\TTextBox} component.
	 ...
	 * @return string the integer timestamp if valid, otherwise the original text.
	 */
