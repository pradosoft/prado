...
class TJuiControlAdapter extends TActiveControlAdapter
{
	...
	/**
	 * Replace default StateTracker with {@see TJuiCallbackPageStateTracker} for
	 ...
	 * {@see TJuiControlOptions} again afterwards since it was not serialized in viewstate.
	 */
