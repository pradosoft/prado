...
Prado::using('System.Db.*');
Prado::using('System.Db.ActiveRecord.*');
Prado::using('System.Base.TEvent');
Prado::using('System.Db.ActiveRecord.TActiveRecordCriteria');
...
# 		return parent::__call($name,$parameters);*/
	...
	public function getRelated($name,$refresh=false,$params=array())
	{
		...
		Prado::trace('lazy loading '.get_class($this).'.'.$name,'System.Db.ActiveRecord.TActiveRecord');
	...
	public function insert($attributes=null)
	{
		...
		if($this->beforeSave())
		{
			Prado::trace(get_class($this).'.insert()','System.Db.ActiveRecord.TActiveRecord');
	...
	public function update($attributes=null)
	{
		...
		if($this->beforeSave())
		{
			Prado::trace(get_class($this).'.update()','System.Db.ActiveRecord.TActiveRecord');
	...
	public function saveAttributes($attributes)
	{
		if(!$this->getIsNewRecord())
		{
			Prado::trace(get_class($this).'.saveAttributes()','System.Db.ActiveRecord.TActiveRecord');
			$values=array();
	...
	public function delete()
	{
		if(!$this->getIsNewRecord())
		{
			Prado::trace(get_class($this).'.delete()','System.Db.ActiveRecord.TActiveRecord');
	...
	{
		Prado::trace(get_class($this).'.refresh()','System.Db.ActiveRecord.TActiveRecord');
	...
	{
		Prado::trace(get_class($this).'.find()','System.Db.ActiveRecord.TActiveRecord');
	...
	{
		Prado::trace(get_class($this).'.findAll()','System.Db.ActiveRecord.TActiveRecord');
		$criteria=$this->getCommandBuilder()->createCriteria($condition,$params);
	...
	{
		Prado::trace(get_class($this).'.findByPk()','System.Db.ActiveRecord.TActiveRecord');
	...
	{
		Prado::trace(get_class($this).'.findAllByPk()','System.Db.ActiveRecord.TActiveRecord');
		$criteria=$this->getCommandBuilder()->createPkCriteria($this->getTableSchema(),$pk,$condition,$params);
		return $this->query($criteria,true);
	}
	...
	{
		Prado::trace(get_class($this).'.findByAttributes()','System.Db.ActiveRecord.TActiveRecord');
	...
	{
		Prado::trace(get_class($this).'.findAllByAttributes()','System.Db.ActiveRecord.TActiveRecord');
		$criteria=$this->getCommandBuilder()->createColumnCriteria($this->getTableSchema(),$attributes,$condition,$params);
		return $this->query($criteria,true);
	}
	...
	{
		Prado::trace(get_class($this).'.findBySql()','System.Db.ActiveRecord.TActiveRecord');
	...
	{
		Prado::trace(get_class($this).'.findAllBySql()','System.Db.ActiveRecord.TActiveRecord');
		$command=$this->getCommandBuilder()->createSqlCommand($sql,$params);
	...
	{
		Prado::trace(get_class($this).'.count()','System.Db.ActiveRecord.TActiveRecord');
		$builder=$this->getCommandBuilder();
	...
	{
		Prado::trace(get_class($this).'.countBySql()','System.Db.ActiveRecord.TActiveRecord');
	...
	{
		Prado::trace(get_class($this).'.exists()','System.Db.ActiveRecord.TActiveRecord');
		$builder=$this->getCommandBuilder();
		$criteria=$builder->createCriteria($condition,$params);
	...
	{
		Prado::trace(get_class($this).'.updateByPk()','System.Db.ActiveRecord.TActiveRecord');
		$builder=$this->getCommandBuilder();
		$table=$this->getTableSchema();
	...
	{
		Prado::trace(get_class($this).'.updateAll()','System.Db.ActiveRecord.TActiveRecord');
		$builder=$this->getCommandBuilder();
		$criteria=$builder->createCriteria($condition,$params);
		$this->applyScopes($criteria);
	...
	{
		Prado::trace(get_class($this).'.updateCounters()','System.Db.ActiveRecord.TActiveRecord');
		$builder=$this->getCommandBuilder();
		$criteria=$builder->createCriteria($condition,$params);
		$this->applyScopes($criteria);
	...
	{
		Prado::trace(get_class($this).'.deleteByPk()','System.Db.ActiveRecord.TActiveRecord');
		$builder=$this->getCommandBuilder();
	...
	{
		Prado::trace(get_class($this).'.deleteAll()','System.Db.ActiveRecord.TActiveRecord');
		$builder=$this->getCommandBuilder();
		$criteria=$builder->createCriteria($condition,$params);
		$this->applyScopes($criteria);
		$command=$builder->createDeleteCommand($this->getTableSchema(),$criteria);
