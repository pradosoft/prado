...
*/
   ...
   */
   ...
   /**
	...
	public $_atFirstPage = false;	/** Added by Iv�n Oliva to implement recordset pagination */
	public $_atLastPage = false;	/** Added by Iv�n Oliva to implement recordset pagination */
