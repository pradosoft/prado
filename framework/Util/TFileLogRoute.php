...
class TFileLogRoute extends TLogRoute
{
	 ...
	 * @throws \Prado\Exceptions\TConfigurationException if log path is invalid
	 */
	 ...
	 * @throws \Prado\Exceptions\TInvalidDataValueException if the value is smaller than 1.
	 */
