 ...
 *
 * Configured as a route inside {@see \Prado\Util\Log\TLogRouter}:
 * ```xml
 * <modules>
 *     <module id="log" class="Prado\Util\Log\TLogRouter">
 *         <route class="Prado\Util\Log\TFirebugLogRoute" Levels="warning,error" />
 *     </module>
 * </modules>
 * ```
 *
 ...
 *             'routes' => [
 *                 ['class' => 'Prado\Util\Log\TFirebugLogRoute', 'properties' => ['Levels' => 'warning,error']],
 *             ],
 *         ],
 *     ],
 * ];
