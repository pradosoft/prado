...
| Directory | Purpose |
|---|---|
| `Configuration/` | XML parsing: statements, parameter maps, result maps, cache models |
| `DataMapper/` | Runtime: type handlers, caches, lazy loading, exceptions |
| `Statements/` | Statement execution: SQL preparation, binding, result mapping |
