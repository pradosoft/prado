...
| Directory | Purpose |
|---|---|
| `Exceptions/` | `TActiveRecordException`, `TActiveRecordConfigurationException` |
| `Relations/` | `TActiveRecordHasOne`, `HasMany`, `BelongsTo`, `HasManyAssociation` + context class |
| `Scaffold/` | Auto-generated CRUD UI controls (`TScaffoldListView`, `TScaffoldEditView`, etc.) |
| `Scaffold/InputBuilder/` | Driver-specific column-to-control mapping for scaffold edit forms |
