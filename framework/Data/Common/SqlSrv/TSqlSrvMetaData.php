 ...
 * @since 3.1
 */
class TSqlSrvMetaData extends TDbMetaData
{
	 ...
	 * @return TSqlSrvTableInfo table information.
	 */
...
<<<EOD
	...
	/**
	 * @param TSqlSrvTableInfo $tableInfo table information.
	...
	protected function processColumn($tableInfo, $col)
	{
		...
		$tableInfo->getColumns()[$columnId] = new TSqlSrvTableColumn($info);
	}

	/**
	 * @param array $col table informations
	 * @return TSqlSrvTableInfo
	 */
